...
@if(!empty($teaching_outputs))
    ...
    @forelse($teaching_outputs as $teaching_output )
        <h2 style="margin-bottom: 5px ; color: #0a58ca; font-weight: bold ;font-size: 14px">{{$teaching_output->name}}</h2>
        <div class="questions">
