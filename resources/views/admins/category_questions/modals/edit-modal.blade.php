    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="modal-reload">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">تعديل محور السؤال</h5>
            </div>
            <div class="modal-body">
                <form action="" method="POST" id="form-edit-category">
                    ...
                    <div class="form-group">
                        <label for="name">محور الاسئله</label>
                        <input type="text" name="name" class="form-control" id="name" placeholder="محور الأسئله"
                               required>
                    </div>
