...
@push('title','هيكل  مكونات البرنامج')
...
@section('content')
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <div class="card-title"> هيكل مكونات البرنامج :: </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <button type="button" class="btn btn-primary waves-effect waves-light"
                            ...
                            <i class="bx bx-add-to-queue font-size-16 align-middle me-2"></i>أضافه هيكل مكونات البرنامج
                        </button>
                    </div>
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 table-striped">
                        ...
                        @forelse($structures  as $structure)
                            <tr>
                                ...
                                <td> <a href="{{ asset(PUBLIC_PATH .'uploads/structure/'.$structure->file_path) }}"><i class="fa fa-file-alt"></i> {{$structure->file_path}} </a> </td>
                                </td>
                                <td>
                                    <div class="btn-group">
                                        <a href="javascript:void(0);" data-category-id="{{ $structure->id }}"
                                           class="text-muted font-size-20 edit"><i class="bx bxs-edit"></i></a>
                                        <form action="{{ route('dashboard.structures.destroy', $structure->id) }}"
    ...
    @include('admins.programs.details.structures.modals.store-modal')
    @include('admins.programs.details.structures.modals.edit-modal')
@endsection
...
@push('scripts')
    ...
    @include('admins.programs.details.structures.scripts.store')
    @include('admins.programs.details.structures.scripts.delete')
    @include('admins.programs.details.structures.scripts.edit')
@endpush
