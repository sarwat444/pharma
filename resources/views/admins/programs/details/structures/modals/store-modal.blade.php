    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">أضافه هيكل مكونات البرنامج </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('dashboard.structures.store')}}" id="store-new-category">
                    @csrf
                    <div class="mb-2">
                        <label for="goal" class="col-form-label">  مكونات البرنامج </label>
