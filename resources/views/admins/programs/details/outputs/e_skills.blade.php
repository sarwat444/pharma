...
@section('content')
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="card-title"> مهارات علمية وذهنية</div>
                    <div class="row mb-3">
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="abilaites" placeholder="أضافه القدرات الذهنيه"
                                   required>
                        </div>
                        <div class="col-md-2">
                    ...
                    <table class="table table-responsive table-bordered table-striped">
                        <thead>
                        <th>#</th>
                        <th>القدرات الذهنيه</th>
                        </thead>
                        <tbody>
                        <tr>
                            <td> 1</td>
                            <td>
                                <p>القدره على التعمل مع اي تغيير </p>
                            </td>
                            <td>
                            <td>
                                <div class="btn-group">
