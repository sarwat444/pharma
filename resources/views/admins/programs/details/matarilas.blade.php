    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-title mb-3">المقرر الألزامى</div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title mb-3">المقرر الأنتقائي</div>
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal"
                            data-bs-target="#create-new-category">
                            <i class="bx bx-add-to-queue font-size-16 align-middle me-2"></i>أضافه مقرر جديد
...
@push('scripts')
    ...
    <!-- Responsive examples -->
    <script src="{{ asset(PUBLIC_PATH . '/assets/admin/libs/datatables.net-responsive/js/dataTables.responsive.min.js') }}">
    </script>
    <script
