...
@push('title','المخرجات التعليمة للبرنامج')
@push('styles')
...
@section('content')
        ...
        <div class="col-md-9">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">المخرجات التعليمة للبرنامج ::</div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <button type="button" class="btn btn-primary waves-effect waves-light"
                            ...
                            <i class="bx bx-add-to-queue font-size-16 align-middle me-2"></i>أضافه القدرات الذهنيه
                        </button>
                    </div>
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 table-striped">
                        ...
                        @forelse($minds  as $mind)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="javascript:void(0);" data-category-id="{{ $mind->id }}"
                                           class="text-muted font-size-20 edit"><i class="bx bxs-edit"></i></a>
                                        <form action="{{ route('dashboard.mind.destroy', $mind->id) }}"
    ...
    @include('admins.programs.details.mind.modals.store-modal')
    @include('admins.programs.details.mind.modals.edit-modal')
@endsection
...
@push('scripts')
    ...
    @include('admins.programs.details.mind.scripts.store')
    @include('admins.programs.details.mind.scripts.delete')
    @include('admins.programs.details.mind.scripts.edit')
@endpush
