...
@section('content')
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">العلامات المرجعية :: </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <button type="button" class="btn btn-primary waves-effect waves-light"
                            ...
                            <i class="bx bx-add-to-queue font-size-16 align-middle me-2"></i>أضافه العلامات المرجعية
                        </button>
                    </div>
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 table-striped">
                        ...
                        @forelse($references  as $reference)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="javascript:void(0);" data-category-id="{{ $reference->id }}"
                                           class="text-muted font-size-20 edit"><i class="bx bxs-edit"></i></a>
                                        <form action="{{ route('dashboard.references.destroy', $reference->id) }}"
    ...
    @include('admins.programs.details.references.modals.store-modal')
    @include('admins.programs.details.references.modals.edit-modal')
@endsection
...
@push('scripts')
    ...
    @include('admins.programs.details.references.scripts.store')
    @include('admins.programs.details.references.scripts.delete')
    @include('admins.programs.details.references.scripts.edit')
@endpush
