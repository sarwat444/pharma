...
@section('content')
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">المهارات العامة :: </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <button type="button" class="btn btn-primary waves-effect waves-light"
                            ...
                            <i class="bx bx-add-to-queue font-size-16 align-middle me-2"></i>أضافه مهارات عامة
                        </button>
                    </div>
                        ...
                        <table id="datatable" class="table table-bordered table-striped">
                            ...
                            @forelse($PublicSkills  as $skill)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="javascript:void(0);" data-category-id="{{ $skill->id }}"
                                               class="text-muted font-size-20 edit"><i class="bx bxs-edit"></i></a>
                                            <form action="{{ route('dashboard.publicSkills.destroy', $skill->id) }}"
    ...
    @include('admins.programs.details.publicskills.modals.store-modal')
    @include('admins.programs.details.publicskills.modals.edit-modal')
@endsection
...
@push('scripts')
    ...
    @include('admins.programs.details.publicskills.scripts.store')
    @include('admins.programs.details.publicskills.scripts.delete')
    @include('admins.programs.details.publicskills.scripts.edit')
@endpush
