...
@section('content')
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">المعرفة والفهم</div>
                </div>
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <button type="button" class="btn btn-primary waves-effect waves-light"
                            ...
                            <i class="bx bx-add-to-queue font-size-16 align-middle me-2"></i>أضافه  المعرفة والفهم
                        </button>
                    </div>
                        ...
                        <table id="datatable" class="table table-bordered  table-striped">
                            ...
                            @forelse($Knowledges  as $Knowledge)
                                <tr>
                                    ...
                                    <td> <p>{{ $Knowledge->name }} </p> </td>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            <a href="javascript:void(0);" data-category-id="{{ $Knowledge->id }}"
                                               class="text-muted font-size-20 edit"><i class="bx bxs-edit"></i></a>
                                            <form action="{{ route('dashboard.Knowledge.destroy', $Knowledge->id) }}"
    ...
    @include('admins.programs.details.Knowledge.modals.store-modal')
    @include('admins.programs.details.Knowledge.modals.edit-modal')
@endsection
...
@push('scripts')
    ...
    @include('admins.programs.details.Knowledge.scripts.store')
    @include('admins.programs.details.Knowledge.scripts.delete')
    @include('admins.programs.details.Knowledge.scripts.edit')
@endpush
