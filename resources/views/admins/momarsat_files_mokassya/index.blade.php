...
<div class="row">
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <button type="button" class="btn btn-primary waves-effect waves-light"
                            ...
                            <i class="bx bx-add-to-queue font-size-16 align-middle me-2"></i>أضافه ملف جديد
                        </button>
                    </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 table-striped">
                            ...
                            @forelse($MomarsatFiles  as $file)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <form action="{{ route('dashboard.momarsat_mokassy_files.destroy', $file->id) }}"
    ...
    @include('admins.momarsat_files_mokassya.modals.store-modal')
    @include('admins.momarsat_files_mokassya.modals.edit-modal')
@endsection
@push('scripts')
    ...
    @include('admins.momarsat_files_mokassya.scripts.store')
    @include('admins.momarsat_files_mokassya.scripts.delete')
    @include('admins.momarsat_files_mokassya.scripts.edit')
@endpush
