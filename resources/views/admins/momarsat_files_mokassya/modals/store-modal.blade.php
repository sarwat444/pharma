    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">أضافه ملف جديد</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('dashboard.momarsat_mokassy_files.store')}}" id="store-new-category">
                    @csrf
                    <div class="mb-2">
                        <label for="program" class="col-form-label"> الملف </label>
                        <input type="file" name="file"  class="form-control" id="type" required>
