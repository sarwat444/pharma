...
<div class="row">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 table-striped">
                            ...
                            @forelse($Momarsas  as $momarsa)
                                <tr>
                                    ...
                                    <td style="text-align: right"><a href="{{route('dashboard.momarsat_files.show' , $momarsa->id )}}">{{ $momarsa->name }} </a> </td>
                                    <td>
                                        <div class="btn-group">
                                            <a href="javascript:void(0);" data-category-id="{{ $momarsa->id }}"
                                               class="text-muted font-size-20 edit"><i class="bx bxs-edit"></i></a>
                                            <form action="{{ route('dashboard.momarsat.destroy', $momarsa->id) }}"
    ...
    @include('admins.momarsat.modals.store-modal')
    @include('admins.momarsat.modals.edit-modal')
@endsection
@push('scripts')
    ...
    @include('admins.momarsat.scripts.store')
    @include('admins.momarsat.scripts.delete')
    @include('admins.momarsat.scripts.edit')
@endpush
