...
<div id="layout-wrapper">
    ...
    @include('admins.rating_members.partials.header')

    <!-- ========== Left Sidebar Start ========== -->
    @include('admins.rating_members.partials.side-menu')
    <!-- Left Sidebar End -->
    ...
    <div class="main-content">
        ...
        @include('admins.rating_members.partials.footer')
    </div>
    <!-- end main content-->
...
<!-- Right Sidebar -->
@include('admins.rating_members.partials.right-bar')
<!-- /Right-bar -->
