    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{$college->college->name}}  </h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);"> {{$college->college->name}} </a></li>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 text-center">
                        ...
                        @forelse($myears as $myear)
                            <tr>
                                ...
                                <td><a  class="college_name" href="{{route('ratingmokassy.mokashers', $myear->id )}}">{{ $myear->name }}</a></td>
