...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title mb-3">  سجل طلاب المقرر -  {{$matrial->name}}  </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 text-center">
                            ...
                            @forelse($students as $student)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{route('dashboard.students.edit' , $student->id )}}" class="text-muted font-size-20 edit"><i class="bx bxs-edit"></i></a>
...
@push('scripts')
    ...
    @include('admins.students.scripts.delete')
@endpush
