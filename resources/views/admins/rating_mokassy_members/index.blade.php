...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title mb-3">اعضاء تحكيم المعايير المؤسسية </div>
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <a href="{{route('dashboard.rating_mokassya.create')}}" class="btn btn-primary waves-effect waves-light">
                    ...
                    <table id="admins-datatable" class="table table-bordered table-striped">
                        ...
                        @foreach($RatingMembers as  $member)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('dashboard.rating_mokassya.edit', $member->id) }}" data-category-id="{{ $member->id }}" class="text-muted font-size-20">
