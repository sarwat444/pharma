                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 table-striped">
                            ...
                            @forelse($Momarsas  as $momarsa)
                                <tr>
                                    ...
                                    <td style="text-align: right"><a href="{{route('rating.momarsa_files' , $momarsa->id )}}">{{ $momarsa->name }} </a> </td>
                                    <td><span class="badge badge-soft-primary">{{$momarsa->files_count}}</span></td>
                                    <td><a class="btn btn-primary" href="{{route('rating.rating_momarsat' , $momarsa->id )}}">  تقيم الممارسه</a></td>
                                </tr>
                            @empty
                                <tr>
