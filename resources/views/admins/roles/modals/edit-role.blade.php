    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('dashboard.edit role')}}</h5>
            ...
            <div class="modal-body">
                <form method="POST" id="form-edit-role">
                    ...
                    @csrf
                    <div class="mb-2">
                        <label for="name" class="col-form-label">{{__('dashboard.role name')}}:</label>
                        <input type="text" name="name" class="form-control" id="name" placeholder="{{__('dashboard.role name')}}" required>
                    </div>
