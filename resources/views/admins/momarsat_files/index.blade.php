...
<div class="row">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 table-striped">
                            ...
                            @forelse($MomarsatFiles  as $file)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <form action="{{ route('dashboard.momarsat.destroy', $file->id) }}"
    ...
    @include('admins.momarsat_files.modals.store-modal')
    @include('admins.momarsat_files.modals.edit-modal')
@endsection
@push('scripts')
    ...
    @include('admins.momarsat_files.scripts.store')
    @include('admins.momarsat_files.scripts.delete')
    @include('admins.momarsat_files.scripts.edit')
@endpush
